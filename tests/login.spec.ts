...
test("test", async ({ page }) => {
  ...
  const progressFile = "./test-data/progress-login.txt";
  ...
  for (let i = startIteration; i <= 5; i++) {
    ...
    await page.locator("#DocTitleStep0").fill("TEST RAYUAN ONLY !!!");
    ...
    await page.locator("#StampingForm_formC_2_ShrTot").fill("1,111,1111");
    await page.locator("#StampingForm_formC_2_ShrTrf").click();
    await page.locator("#StampingForm_formC_2_ShrTrf").fill("1,111,1111");
    ...
    await page.getByRole("textbox", { name: "0.00" }).fill("2,123,123,1231.01");
    ...
    await page.getByRole("cell", { name: "9992639989867684" }).click();
